...
<body style="font-family: Arial, sans-serif; color: #1f2937; max-width: 600px; margin: 0 auto; padding: 24px;">
    ...
    <p style="color: #6b7280; margin-top: 0;">Re: {{ $inquiry->subject ?: 'Your inquiry' }}</p>

    <p>Hi {{ $inquiry->name }},</p>

    <div style="white-space: pre-line; margin: 16px 0;">{{ $replyMessage }}</div>

    <hr style="border: none; border-top: 1px solid #e5e7eb; margin: 24px 0;">

    <p style="color: #6b7280; font-size: 13px;">Your original message:</p>
    <p style="color: #6b7280; font-size: 13px; white-space: pre-line;">{{ $inquiry->message }}</p>
